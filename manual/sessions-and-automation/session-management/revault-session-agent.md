...
The agent does **not** normally retain your Vault passphrase. [Auto Open](./#auto-open) is the separate feature that stores that passphrase in the platform credential store.
