...
Terminology follows [terminology.md](terminology.md): a **lockbox** is the portable `.lbox` encrypted container, while a **vault** is the user's local private store on their own computer.
