...
Follow [Recover a damaged Lockbox](cli-tooling/recovery.md). The command automatically distinguishes authenticated interrupted rollback, cleanup or truncation from salvage recovery; no recovery-mode flag is required.
