//! Authoritative logical export using the frozen v2/v3 reader.
//!
//! `legacy/src` is the format-v3 implementation from reVault commit
//! e5f534bfde6c7165f8168ada95ce98af2526805c. Its package is renamed to
//! revault_archive_v3_reader; archive decoding remains isolated from the v4
//! core. Export only reachable committed records, never scanned orphan pages.
mod vault;
pub use vault::export_vault;

use revault_lockbox_api::{
    FormDefinition, FormFieldKind, FormValue, ListOptions, Lockbox, LockboxEntryKind, LockboxPath,
    SecretVec, VariableSensitivity,
};
