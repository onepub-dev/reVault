...
The vault API stores identities, contacts, signing keys, lockbox key-directory
...
Use it above `revault_lockbox_api` when an application needs local identity and
