//! Authoritative logical export using the frozen v4 reader.
//!
//! `legacy/src` is the format-v4 implementation from reVault commit
//! a108240. Its package is renamed to
//! revault_archive_v4_reader; archive decoding remains isolated from the v5
