...
let buffer_last_error;
let buffer_last_error_details;
let buffer_free;
let secret_len;
let secret_copy;
let secret_free;
let lockbox_format_version;
let lockbox_probe_format_version;
let lockbox_create;
...
let lockbox_open_contact;
let lockbox_add_file;
let lockbox_add_file_with_permissions;
let lockbox_get_file;
let lockbox_extract_file;
let lockbox_extract_directory;
let lockbox_stream_content;
let lockbox_cache_stats;
let lockbox_import_stats;
let lockbox_reset_import_stats;
let lockbox_inspect_file;
let lockbox_page_inspection;
let lockbox_recovery_report;
let lockbox_recovery_report_render;
let lockbox_recovery_scan_path;
let lockbox_storage_len;
let lockbox_set_workload_profile;
let lockbox_set_worker_policy;
let lockbox_runtime_options;
let lockbox_commit;
let lockbox_create_dir;
let lockbox_delete;
let lockbox_remove_dir;
let lockbox_create_parent_dirs;
let lockbox_rename;
let lockbox_list;
let lockbox_list_with_options;
let lockbox_stat;
let lockbox_set_variable;
let lockbox_set_secret_variable;
let lockbox_get_variable;
let lockbox_get_secret_variable;
let lockbox_delete_variable;
let lockbox_move_variables;
let lockbox_list_variables;
let lockbox_variable_sensitivity;
let lockbox_add_symlink;
let lockbox_get_symlink_target;
let lockbox_id;
let lockbox_exists;
let lockbox_is_dir;
let lockbox_permissions;
let lockbox_set_permissions;
let lockbox_read_range;
let lockbox_recovery_scan;
let lockbox_recovery_salvage;
let lockbox_add_password;
let lockbox_add_contact;
let lockbox_delete_key;
let lockbox_list_key_slots;
let lockbox_set_owner_signing_key;
let lockbox_owner_inspection;
let lockbox_define_form;
let lockbox_list_form_definitions;
let lockbox_resolve_form;
let lockbox_list_form_revisions;
let lockbox_create_form_record;
let lockbox_set_form_field;
let lockbox_set_secret_form_field;
let lockbox_list_form_records;
let lockbox_get_form_record;
let lockbox_delete_form_record;
let lockbox_move_form_records;
let lockbox_get_form_field;
let lockbox_get_secret_form_field;
let lockbox_to_bytes;
let lockbox_free;
let vault_is_running;
let vault_forget_all;
let key_contact_generate;
let key_contact_from_private;
let key_contact_public;
let key_contact_private;
let key_contact_public_from_bytes;
let key_contact_public_free;
let key_contact_free;
let key_contact_encrypt;
let key_contact_decrypt;
let key_contact_wrapped_public;
let key_contact_wrapped_ciphertext;
let key_contact_wrapped_encrypted;
let key_contact_wrapped_free;
let key_signing_generate;
let key_signing_from_private;
let key_signing_public;
let key_signing_private;
let key_signing_public_from_bytes;
let key_signing_public_free;
let key_signing_free;
let vault_key_export_private;
let vault_key_export_public;
let vault_key_import_private;
let vault_key_import_public;
let vault_key_fingerprint;
let vault_key_format_hex;
let vault_key_decode_hex;
let vault_key_format_crockford;
let vault_key_format_crockford_reading;
let vault_key_decode_crockford;
let vault_key_hex_encode;
let vault_key_hex_decode;
let vault_directory_open;
let vault_structure_version_current;
let vault_directory_probe_structure_version;
let vault_directory_open_or_create_default;
let vault_directory_replace_default;
let vault_directory_change_password;
let vault_directory_change_default_password;
let vault_directory_replace;
let vault_directory_open_or_create;
let vault_directory_root;
let vault_directory_structure_version;
let vault_directory_list_private_keys;
let vault_directory_list_private_key_names;
let vault_directory_list_contact_names;
let vault_directory_list_form_aliases;
let vault_directory_private_key_exists;
let vault_directory_delete_private_key;
let vault_directory_store_private_key;
let vault_directory_load_private_key;
let vault_directory_load_private_key_generation;
let vault_directory_store_contact;
let vault_directory_load_contact;
let vault_directory_contact_exists;
let vault_directory_delete_contact;
let vault_directory_list_contacts;
let vault_directory_store_profile_email;
let vault_directory_profile_email;
let vault_directory_store_backup;
let vault_directory_load_backup;
let vault_directory_backup_count;
let vault_directory_restore_private_key;
let vault_directory_load_owner_signing_key;
let vault_directory_load_owner_signing_key_generation;
let vault_directory_store_contact_signing_key;
let vault_directory_load_contact_signing_key;
let vault_directory_list_profile_generations;
let vault_directory_rotate_private_key;
let vault_directory_remember_lockbox;
let vault_directory_list_known_lockboxes;
let vault_directory_forget_lockbox;
let vault_directory_remember_access_slot_label;
let vault_directory_list_access_slot_labels;
let vault_directory_find_access_slot_labels;
let vault_directory_forget_access_slot_label;
let vault_directory_define_form;
let vault_directory_resolve_form;
let vault_directory_list_forms;
let vault_directory_list_form_revisions;
let vault_directory_seed_forms;
let vault_directory_remember_password;
let vault_directory_remembered_password;
let vault_backup_default;
let vault_restore_default;
let vault_directory_free;
let vault_read_only_open;
let vault_read_only_open_default;
let vault_read_only_list_profile_names;
let vault_read_only_list_contact_names;
let vault_read_only_list_form_aliases;
let vault_read_only_list_known_lockboxes;
let vault_read_only_free;
let vault_agent_serve;
let vault_agent_verify_transport;
let vault_agent_get;
let vault_agent_put;
let vault_agent_forget;
let vault_agent_stop;
let vault_agent_start;
let vault_agent_list;
let vault_agent_sleep_support;
let vault_platform_status;
let vault_platform_set_scope;
let vault_platform_forget_password;
let vault_platform_put_password;
let vault_platform_enable;
let vault_platform_disable;
let vault_platform_disabled;
let vault_platform_get_password;
let vault_default_directory;
let vault_default_path;
let vault_agent_log_path;
let vault_agent_log_destination;
let vault_agent_get_vault_unlock_key;
let vault_agent_put_vault_unlock_key;
let vault_agent_forget_vault_unlock_key;
let vault_agent_get_owner_signing_key;
let vault_agent_put_owner_signing_key;
let vault_agent_forget_owner_signing_key;
let vault_agent_begin_activity;
let vault_agent_end_activity;
let vault_local;
let vault_create_lockbox_password;
let vault_open_lockbox_password;
let vault_create_lockbox_content_key;
let vault_create_lockbox_contact;
let vault_open_lockbox_content_key;
let vault_cache_lockbox_password;
let vault_close_lockbox;
let vault_close_all;
let vault_free;

export function configureNativeLibrary(explicitPath = undefined) {
  if ((explicitPath === undefined || explicitPath === null) && loadedLibraryPath !== undefined) return;
  const selectedPath = nativeLibraryPath(explicitPath);
  if (loadedLibraryPath === selectedPath) return;
  if (loadedLibraryPath !== undefined) {
    throw new Error(`the process-wide reVault native library is already loaded from ${loadedLibraryPath}`);
  }
  library = koffi.load(selectedPath);
  api_abi_version = library.func('uint32_t api_abi_version(void)');
  buffer_last_error = library.func('const char * buffer_last_error(void)');
  buffer_last_error_details = library.func('RevaultBuffer buffer_last_error_details(void)');
  buffer_free = library.func('void buffer_free(RevaultBuffer)');
  secret_len = library.func('bool secret_len(void *, _Out_ size_t *)');
  secret_copy = library.func('bool secret_copy(void *, void *, size_t)');
  secret_free = library.func('void secret_free(void *)');
  lockbox_format_version = library.func('uint16_t lockbox_format_version(void)');
  lockbox_probe_format_version = library.func('uint16_t lockbox_probe_format_version(void *, size_t)');
  ...
  lockbox_open_contact = library.func('void * lockbox_open_contact(void *, size_t, void *)');
  lockbox_add_file = library.func('bool lockbox_add_file(void *, const char *, size_t, void *, size_t, bool)');
  lockbox_add_file_with_permissions = library.func('bool lockbox_add_file_with_permissions(void *, const char *, size_t, void *, size_t, uint32_t, bool)');
  lockbox_get_file = library.func('RevaultBuffer lockbox_get_file(void *, const char *, size_t)');
  lockbox_extract_file = library.func('bool lockbox_extract_file(void *, const char *, size_t, const char *, size_t, bool)');
  lockbox_extract_directory = library.func('bool lockbox_extract_directory(void *, const char *, size_t, uint64_t, uint64_t, size_t, bool, bool, bool)');
  lockbox_stream_content = library.func('RevaultBuffer lockbox_stream_content(void *, bool)');
  lockbox_cache_stats = library.func('RevaultBuffer lockbox_cache_stats(void *)');
  lockbox_import_stats = library.func('RevaultBuffer lockbox_import_stats(void *)');
  lockbox_reset_import_stats = library.func('bool lockbox_reset_import_stats(void *)');
  lockbox_inspect_file = library.func('RevaultBuffer lockbox_inspect_file(const char *, size_t)');
  lockbox_page_inspection = library.func('RevaultBuffer lockbox_page_inspection(void *)');
  lockbox_recovery_report = library.func('RevaultBuffer lockbox_recovery_report(void *)');
  lockbox_recovery_report_render = library.func('RevaultBuffer lockbox_recovery_report_render(void *, bool, size_t)');
  lockbox_recovery_scan_path = library.func('RevaultBuffer lockbox_recovery_scan_path(const char *, size_t, void *, size_t)');
  lockbox_storage_len = library.func('uint64_t lockbox_storage_len(void *)');
  lockbox_set_workload_profile = library.func('bool lockbox_set_workload_profile(void *, const char *, size_t)');
  lockbox_set_worker_policy = library.func('bool lockbox_set_worker_policy(void *, const char *, size_t, size_t)');
  lockbox_runtime_options = library.func('RevaultBuffer lockbox_runtime_options(void *)');
  lockbox_commit = library.func('bool lockbox_commit(void *)');
  lockbox_create_dir = library.func('bool lockbox_create_dir(void *, const char *, size_t, bool)');
  lockbox_delete = library.func('bool lockbox_delete(void *, const char *, size_t)');
  lockbox_remove_dir = library.func('bool lockbox_remove_dir(void *, const char *, size_t, bool)');
  lockbox_create_parent_dirs = library.func('bool lockbox_create_parent_dirs(void *, const char *, size_t)');
  lockbox_rename = library.func('bool lockbox_rename(void *, const char *, size_t, const char *, size_t)');
  lockbox_list = library.func('RevaultBuffer lockbox_list(void *, const char *, size_t, bool)');
  lockbox_list_with_options = library.func('RevaultBuffer lockbox_list_with_options(void *, const char *, size_t, const char *, size_t, bool, bool, bool, bool, size_t)');
  lockbox_stat = library.func('RevaultBuffer lockbox_stat(void *, const char *, size_t)');
  lockbox_set_variable = library.func('bool lockbox_set_variable(void *, const char *, size_t, const char *, size_t)');
  lockbox_set_secret_variable = library.func('bool lockbox_set_secret_variable(void *, const char *, size_t, void *, size_t)');
  lockbox_get_variable = library.func('RevaultBuffer lockbox_get_variable(void *, const char *, size_t)');
  lockbox_get_secret_variable = library.func('bool lockbox_get_secret_variable(void *, const char *, size_t, _Out_ void **)');
  lockbox_delete_variable = library.func('bool lockbox_delete_variable(void *, const char *, size_t)');
  lockbox_move_variables = library.func('bool lockbox_move_variables(void *, void *, size_t)');
  lockbox_list_variables = library.func('RevaultBuffer lockbox_list_variables(void *)');
  lockbox_variable_sensitivity = library.func('RevaultBuffer lockbox_variable_sensitivity(void *, const char *, size_t)');
  lockbox_add_symlink = library.func('bool lockbox_add_symlink(void *, const char *, size_t, const char *, size_t, bool)');
  lockbox_get_symlink_target = library.func('RevaultBuffer lockbox_get_symlink_target(void *, const char *, size_t)');
  lockbox_id = library.func('RevaultBuffer lockbox_id(void *)');
  lockbox_exists = library.func('bool lockbox_exists(void *, const char *, size_t)');
  lockbox_is_dir = library.func('bool lockbox_is_dir(void *, const char *, size_t)');
  lockbox_permissions = library.func('uint32_t lockbox_permissions(void *, const char *, size_t)');
  lockbox_set_permissions = library.func('bool lockbox_set_permissions(void *, const char *, size_t, uint32_t)');
  lockbox_read_range = library.func('RevaultBuffer lockbox_read_range(void *, const char *, size_t, uint64_t, uint64_t)');
  lockbox_recovery_scan = library.func('RevaultBuffer lockbox_recovery_scan(void *, size_t, void *, size_t)');
  lockbox_recovery_salvage = library.func('void * lockbox_recovery_salvage(void *, size_t, void *, size_t, void *)');
  lockbox_add_password = library.func('uint64_t lockbox_add_password(void *, void *, size_t)');
  lockbox_add_contact = library.func('uint64_t lockbox_add_contact(void *, void *, const char *, size_t)');
  lockbox_delete_key = library.func('bool lockbox_delete_key(void *, uint64_t)');
  lockbox_list_key_slots = library.func('RevaultBuffer lockbox_list_key_slots(void *)');
  lockbox_set_owner_signing_key = library.func('bool lockbox_set_owner_signing_key(void *, void *)');
  lockbox_owner_inspection = library.func('RevaultBuffer lockbox_owner_inspection(void *)');
  lockbox_define_form = library.func('RevaultBuffer lockbox_define_form(void *, const char *, size_t, const char *, size_t, const char *, size_t, void *, size_t)');
  lockbox_list_form_definitions = library.func('RevaultBuffer lockbox_list_form_definitions(void *)');
  lockbox_resolve_form = library.func('RevaultBuffer lockbox_resolve_form(void *, const char *, size_t)');
  lockbox_list_form_revisions = library.func('RevaultBuffer lockbox_list_form_revisions(void *, const char *, size_t)');
  lockbox_create_form_record = library.func('RevaultBuffer lockbox_create_form_record(void *, const char *, size_t, const char *, size_t, const char *, size_t)');
  lockbox_set_form_field = library.func('bool lockbox_set_form_field(void *, const char *, size_t, const char *, size_t, const char *, size_t)');
  lockbox_set_secret_form_field = library.func('bool lockbox_set_secret_form_field(void *, const char *, size_t, const char *, size_t, void *, size_t)');
  lockbox_list_form_records = library.func('RevaultBuffer lockbox_list_form_records(void *)');
  lockbox_get_form_record = library.func('RevaultBuffer lockbox_get_form_record(void *, const char *, size_t)');
  lockbox_delete_form_record = library.func('bool lockbox_delete_form_record(void *, const char *, size_t)');
  lockbox_move_form_records = library.func('bool lockbox_move_form_records(void *, void *, size_t)');
  lockbox_get_form_field = library.func('RevaultBuffer lockbox_get_form_field(void *, const char *, size_t, const char *, size_t)');
  lockbox_get_secret_form_field = library.func('bool lockbox_get_secret_form_field(void *, const char *, size_t, const char *, size_t, _Out_ void **)');
  lockbox_to_bytes = library.func('RevaultBuffer lockbox_to_bytes(void *)');
  lockbox_free = library.func('void lockbox_free(void *)');
  vault_is_running = library.func('bool vault_is_running(void)');
  vault_forget_all = library.func('bool vault_forget_all(void)');
  key_contact_generate = library.func('void * key_contact_generate(void)');
  key_contact_from_private = library.func('void * key_contact_from_private(void *, size_t)');
  key_contact_public = library.func('RevaultBuffer key_contact_public(void *)');
  key_contact_private = library.func('RevaultBuffer key_contact_private(void *)');
  key_contact_public_from_bytes = library.func('void * key_contact_public_from_bytes(void *, size_t)');
  key_contact_public_free = library.func('void key_contact_public_free(void *)');
  key_contact_free = library.func('void key_contact_free(void *)');
  key_contact_encrypt = library.func('void * key_contact_encrypt(void *, void *, size_t)');
  key_contact_decrypt = library.func('RevaultBuffer key_contact_decrypt(void *, void *)');
  key_contact_wrapped_public = library.func('RevaultBuffer key_contact_wrapped_public(void *)');
  key_contact_wrapped_ciphertext = library.func('RevaultBuffer key_contact_wrapped_ciphertext(void *)');
  key_contact_wrapped_encrypted = library.func('RevaultBuffer key_contact_wrapped_encrypted(void *)');
  key_contact_wrapped_free = library.func('void key_contact_wrapped_free(void *)');
  key_signing_generate = library.func('void * key_signing_generate(void)');
  key_signing_from_private = library.func('void * key_signing_from_private(void *, size_t)');
  key_signing_public = library.func('RevaultBuffer key_signing_public(void *)');
  key_signing_private = library.func('RevaultBuffer key_signing_private(void *)');
  key_signing_public_from_bytes = library.func('void * key_signing_public_from_bytes(void *, size_t)');
  key_signing_public_free = library.func('void key_signing_public_free(void *)');
  key_signing_free = library.func('void key_signing_free(void *)');
  vault_key_export_private = library.func('RevaultBuffer vault_key_export_private(void *, const char *, size_t)');
  vault_key_export_public = library.func('RevaultBuffer vault_key_export_public(void *, const char *, size_t)');
  vault_key_import_private = library.func('void * vault_key_import_private(void *, size_t)');
  vault_key_import_public = library.func('void * vault_key_import_public(void *, size_t)');
  vault_key_fingerprint = library.func('RevaultBuffer vault_key_fingerprint(void *)');
  vault_key_format_hex = library.func('RevaultBuffer vault_key_format_hex(void *, size_t)');
  vault_key_decode_hex = library.func('RevaultBuffer vault_key_decode_hex(const char *, size_t)');
  vault_key_format_crockford = library.func('RevaultBuffer vault_key_format_crockford(void *, size_t)');
  vault_key_format_crockford_reading = library.func('RevaultBuffer vault_key_format_crockford_reading(const char *, size_t)');
  vault_key_decode_crockford = library.func('RevaultBuffer vault_key_decode_crockford(const char *, size_t)');
  vault_key_hex_encode = library.func('RevaultBuffer vault_key_hex_encode(void *, size_t)');
  vault_key_hex_decode = library.func('RevaultBuffer vault_key_hex_decode(const char *, size_t)');
  vault_directory_open = library.func('void * vault_directory_open(const char *, size_t, void *, size_t)');
  vault_structure_version_current = library.func('uint32_t vault_structure_version_current(void)');
  vault_directory_probe_structure_version = library.func('uint32_t vault_directory_probe_structure_version(const char *, size_t, void *, size_t)');
  vault_directory_open_or_create_default = library.func('void * vault_directory_open_or_create_default(void *, size_t)');
  vault_directory_replace_default = library.func('void * vault_directory_replace_default(void *, size_t)');
  vault_directory_change_password = library.func('bool vault_directory_change_password(const char *, size_t, void *, size_t, void *, size_t)');
  vault_directory_change_default_password = library.func('bool vault_directory_change_default_password(void *, size_t, void *, size_t)');
  vault_directory_replace = library.func('void * vault_directory_replace(const char *, size_t, void *, size_t)');
  vault_directory_open_or_create = library.func('void * vault_directory_open_or_create(const char *, size_t, void *, size_t)');
  vault_directory_root = library.func('RevaultBuffer vault_directory_root(void *)');
  vault_directory_structure_version = library.func('uint32_t vault_directory_structure_version(void *)');
  vault_directory_list_private_keys = library.func('RevaultBuffer vault_directory_list_private_keys(void *)');
  vault_directory_list_private_key_names = library.func('RevaultBuffer vault_directory_list_private_key_names(void *)');
  vault_directory_list_contact_names = library.func('RevaultBuffer vault_directory_list_contact_names(void *)');
  vault_directory_list_form_aliases = library.func('RevaultBuffer vault_directory_list_form_aliases(void *)');
  vault_directory_private_key_exists = library.func('bool vault_directory_private_key_exists(void *, const char *, size_t)');
  vault_directory_delete_private_key = library.func('bool vault_directory_delete_private_key(void *, const char *, size_t)');
  vault_directory_store_private_key = library.func('bool vault_directory_store_private_key(void *, const char *, size_t, void *)');
  vault_directory_load_private_key = library.func('void * vault_directory_load_private_key(void *, const char *, size_t)');
  vault_directory_load_private_key_generation = library.func('void * vault_directory_load_private_key_generation(void *, const char *, size_t, uint16_t)');
  vault_directory_store_contact = library.func('bool vault_directory_store_contact(void *, const char *, size_t, void *)');
  vault_directory_load_contact = library.func('void * vault_directory_load_contact(void *, const char *, size_t)');
  vault_directory_contact_exists = library.func('bool vault_directory_contact_exists(void *, const char *, size_t)');
  vault_directory_delete_contact = library.func('bool vault_directory_delete_contact(void *, const char *, size_t)');
  vault_directory_list_contacts = library.func('RevaultBuffer vault_directory_list_contacts(void *)');
  vault_directory_store_profile_email = library.func('bool vault_directory_store_profile_email(void *, const char *, size_t, const char *, size_t)');
  vault_directory_profile_email = library.func('RevaultBuffer vault_directory_profile_email(void *, const char *, size_t)');
  vault_directory_store_backup = library.func('bool vault_directory_store_backup(void *, void *, size_t, void *, size_t)');
  vault_directory_load_backup = library.func('RevaultBuffer vault_directory_load_backup(void *, void *, size_t)');
  vault_directory_backup_count = library.func('uint64_t vault_directory_backup_count(void *)');
  vault_directory_restore_private_key = library.func('bool vault_directory_restore_private_key(void *, const char *, size_t, void *, void *, bool)');
  vault_directory_load_owner_signing_key = library.func('void * vault_directory_load_owner_signing_key(void *, const char *, size_t)');
  vault_directory_load_owner_signing_key_generation = library.func('void * vault_directory_load_owner_signing_key_generation(void *, const char *, size_t, uint16_t)');
  vault_directory_store_contact_signing_key = library.func('bool vault_directory_store_contact_signing_key(void *, const char *, size_t, void *)');
  vault_directory_load_contact_signing_key = library.func('void * vault_directory_load_contact_signing_key(void *, const char *, size_t)');
  vault_directory_list_profile_generations = library.func('RevaultBuffer vault_directory_list_profile_generations(void *, const char *, size_t)');
  vault_directory_rotate_private_key = library.func('RevaultBuffer vault_directory_rotate_private_key(void *, const char *, size_t)');
  vault_directory_remember_lockbox = library.func('bool vault_directory_remember_lockbox(void *, void *, size_t, const char *, size_t)');
  vault_directory_list_known_lockboxes = library.func('RevaultBuffer vault_directory_list_known_lockboxes(void *)');
  vault_directory_forget_lockbox = library.func('bool vault_directory_forget_lockbox(void *, const char *, size_t)');
  vault_directory_remember_access_slot_label = library.func('bool vault_directory_remember_access_slot_label(void *, void *, size_t, uint64_t, const char *, size_t)');
  vault_directory_list_access_slot_labels = library.func('RevaultBuffer vault_directory_list_access_slot_labels(void *, void *, size_t)');
  vault_directory_find_access_slot_labels = library.func('RevaultBuffer vault_directory_find_access_slot_labels(void *, void *, size_t, const char *, size_t)');
  vault_directory_forget_access_slot_label = library.func('bool vault_directory_forget_access_slot_label(void *, void *, size_t, uint64_t)');
  vault_directory_define_form = library.func('RevaultBuffer vault_directory_define_form(void *, const char *, size_t, const char *, size_t, const char *, size_t, void *, size_t)');
  vault_directory_resolve_form = library.func('RevaultBuffer vault_directory_resolve_form(void *, const char *, size_t)');
  vault_directory_list_forms = library.func('RevaultBuffer vault_directory_list_forms(void *)');
  vault_directory_list_form_revisions = library.func('RevaultBuffer vault_directory_list_form_revisions(void *, const char *, size_t)');
  vault_directory_seed_forms = library.func('size_t vault_directory_seed_forms(void *)');
  vault_directory_remember_password = library.func('bool vault_directory_remember_password(void *, void *, size_t, void *, size_t)');
  vault_directory_remembered_password = library.func('RevaultBuffer vault_directory_remembered_password(void *, void *, size_t)');
  vault_backup_default = library.func('RevaultBuffer vault_backup_default(const char *, size_t, bool)');
  vault_restore_default = library.func('RevaultBuffer vault_restore_default(const char *, size_t, bool)');
  vault_directory_free = library.func('void vault_directory_free(void *)');
  vault_read_only_open = library.func('void * vault_read_only_open(const char *, size_t, void *, size_t)');
  vault_read_only_open_default = library.func('void * vault_read_only_open_default(void *, size_t)');
  vault_read_only_list_profile_names = library.func('RevaultBuffer vault_read_only_list_profile_names(void *)');
  vault_read_only_list_contact_names = library.func('RevaultBuffer vault_read_only_list_contact_names(void *)');
  vault_read_only_list_form_aliases = library.func('RevaultBuffer vault_read_only_list_form_aliases(void *)');
  vault_read_only_list_known_lockboxes = library.func('RevaultBuffer vault_read_only_list_known_lockboxes(void *)');
  vault_read_only_free = library.func('void vault_read_only_free(void *)');
  vault_agent_serve = library.func('bool vault_agent_serve(void)');
  vault_agent_verify_transport = library.func('bool vault_agent_verify_transport(void)');
  vault_agent_get = library.func('RevaultBuffer vault_agent_get(void *, size_t)');
  vault_agent_put = library.func('bool vault_agent_put(void *, size_t, void *, size_t)');
  vault_agent_forget = library.func('bool vault_agent_forget(void *, size_t)');
  vault_agent_stop = library.func('bool vault_agent_stop(void)');
  vault_agent_start = library.func('bool vault_agent_start(void)');
  vault_agent_list = library.func('RevaultBuffer vault_agent_list(void)');
  vault_agent_sleep_support = library.func('RevaultBuffer vault_agent_sleep_support(void)');
  vault_platform_status = library.func('RevaultBuffer vault_platform_status(void)');
  vault_platform_set_scope = library.func('bool vault_platform_set_scope(const char *, size_t)');
  vault_platform_forget_password = library.func('bool vault_platform_forget_password(void)');
  vault_platform_put_password = library.func('bool vault_platform_put_password(void *, size_t)');
  vault_platform_enable = library.func('bool vault_platform_enable(void)');
  vault_platform_disable = library.func('bool vault_platform_disable(void)');
  vault_platform_disabled = library.func('bool vault_platform_disabled(void)');
  vault_platform_get_password = library.func('RevaultBuffer vault_platform_get_password(void)');
  vault_default_directory = library.func('RevaultBuffer vault_default_directory(void)');
  vault_default_path = library.func('RevaultBuffer vault_default_path(void)');
  vault_agent_log_path = library.func('RevaultBuffer vault_agent_log_path(void)');
  vault_agent_log_destination = library.func('RevaultBuffer vault_agent_log_destination(void)');
  vault_agent_get_vault_unlock_key = library.func('RevaultBuffer vault_agent_get_vault_unlock_key(const char *, size_t)');
  vault_agent_put_vault_unlock_key = library.func('bool vault_agent_put_vault_unlock_key(const char *, size_t, void *, size_t, uint64_t)');
  vault_agent_forget_vault_unlock_key = library.func('bool vault_agent_forget_vault_unlock_key(const char *, size_t)');
  vault_agent_get_owner_signing_key = library.func('void * vault_agent_get_owner_signing_key(const char *, size_t, const char *, size_t)');
  vault_agent_put_owner_signing_key = library.func('bool vault_agent_put_owner_signing_key(const char *, size_t, const char *, size_t, void *, uint64_t)');
  vault_agent_forget_owner_signing_key = library.func('bool vault_agent_forget_owner_signing_key(const char *, size_t, const char *, size_t)');
  vault_agent_begin_activity = library.func('void * vault_agent_begin_activity(const char *, size_t)');
  vault_agent_end_activity = library.func('void vault_agent_end_activity(void *)');
  vault_local = library.func('void * vault_local(void)');
  vault_create_lockbox_password = library.func('void * vault_create_lockbox_password(void *, const char *, size_t, void *, size_t)');
  vault_open_lockbox_password = library.func('void * vault_open_lockbox_password(void *, const char *, size_t, void *, size_t)');
  vault_create_lockbox_content_key = library.func('void * vault_create_lockbox_content_key(void *, const char *, size_t, void *, size_t, void *)');
  vault_create_lockbox_contact = library.func('void * vault_create_lockbox_contact(void *, const char *, size_t, void *, const char *, size_t, void *)');
  vault_open_lockbox_content_key = library.func('void * vault_open_lockbox_content_key(void *, const char *, size_t, void *, size_t, void *)');
  vault_cache_lockbox_password = library.func('bool vault_cache_lockbox_password(void *, const char *, size_t, void *, size_t, uint64_t)');
  vault_close_lockbox = library.func('bool vault_close_lockbox(void *, const char *, size_t)');
  vault_close_all = library.func('bool vault_close_all(void *)');
  vault_free = library.func('void vault_free(void *)');
  if (api_abi_version() !== 3) throw new Error('revault-api native ABI mismatch; expected 3');
  loadedLibraryPath = selectedPath;
}
...
export class BindingOperations {
  constructor(nativeLibraryPath = undefined) { configureNativeLibrary(nativeLibraryPath); }
